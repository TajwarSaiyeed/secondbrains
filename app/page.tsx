      ...
      <section className="py-20 px-4">
        <div className="container mx-auto text-center max-w-4xl">
          ...
          <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
            Transform your learning experience with intelligent study boards,
            seamless collaboration, and AI-driven insights that help you
      ...
      <section className="py-20 px-4">
        <div className="container mx-auto text-center max-w-3xl">
          ...
          <p className="text-lg text-muted-foreground mb-8">
            ...
            MindMesh to study smarter, not harder.
          </p>
          <Button size="lg" asChild className="text-lg px-8 py-6">
      ...
      <footer className="border-t border-border py-8 px-4">
        <div className="container mx-auto text-center">
          ...
          <p className="text-muted-foreground">
            © {new Date().getFullYear()} MindMesh. Empowering collaborative
            learning with AI.
          </p>
        </div>
      </footer>
