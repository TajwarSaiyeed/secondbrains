...
export async function sendInviteEmail(email: string, boardTitle: string, inviteUrl: string, message?: string) {
  try {
    ...
    const mailOptions = {
      from: process.env.EMAIL_FROM || '"SecondBrains" <noreply@secondbrains.com>',
      to: email,
